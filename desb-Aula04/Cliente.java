// Classe Cliente
/* 
Nesta primeira etapa, o cliente é um numero 
...
public class Cliente {
    ...
    // Cria o constutor com o setters para validar os dados
...
public Cliente(
    ...
    // Setter com vlidação usando apenas valores numericos
    ...
    public void setNivel(int nivel) {
        if(nivel >=1 && nivel <=3) {
            ...
            System.out.print("Erro: o nivel deve ser 1, 2 ou 3");
 ...
 */
    public void exibirResumo(){
        ...
        System.out.println("Consultor Responsavel: " + consultorResponsavel.getNome());
    }
